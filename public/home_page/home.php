                    ...
                    <table class="table sensor-table">
                        ...
                        <tbody id="tabelaSensores">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="action-buttons">
                                        ...
                                        <button class="delete" onclick="window.location.href='./sensor/deletesensor.php'">
                                            <img src="../../assets/images/lixeirabutton.png" id="deletebutton">
                                        </button>
                                        <button class="view" onclick="window.location.href='../monitoramento_page/monitoramento.php'">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="action-buttons">
                                        <button class="edit"><img src="../../assets/images/editbutton.png" id="editbutton"></button>
                                        <button class="delete"><img src="../../assets/images/lixeirabutton.png" id="deletebutton"></button>
                                        <button class="view"><img src="../../assets/images/visualizabutton.png" id="viewbutton"></button>
                                    </div>
                                </td>
                            </tr>
